...
* The original package name 'com.example.stock-microservice' is invalid and this project uses 'com.example.stock_microservice' instead.
...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/3.4.8/reference/web/spring-security.html#web.security.oauth2.server)
