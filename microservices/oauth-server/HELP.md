...
* The original package name 'com.example.oauth-server' is invalid and this project uses 'com.example.oauth_server' instead.
...
* [OAuth2 Authorization Server](https://docs.spring.io/spring-boot/3.4.9/reference/web/spring-security.html#web.security.oauth2.authorization-server)
